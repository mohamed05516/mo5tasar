...
export default function Mo5tasarApp() {
  ...
  const handleSendMessage = async (explicitText = null) => {
    ...
    try {
      ...
      const systemPrompt = `أنت "مختصر AI"، مساعد تعليمي جزائري خبير. 
      المستوى: ${curriculumStep.year || 'غير محدد'} | المادة: ${curriculumStep.subject || 'عامة'}.
      المطلوب: ${detailLevel}
      تحدث بلهجة جزائرية خفيفة مهذبة عند الضرورة لتشجيع التلميذ. استخدم التنسيق الجميل (Markdown).`;
